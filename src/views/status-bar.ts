...
export class StatusBarManager {
	...
	show(): void { this.visible = true; this.statusBarItem.show(); }
	hide(): void { this.visible = false; this.statusBarItem.hide(); }
	...
	private startPeriodicUpdate(): void {
		...
		this.updateTimer = setInterval(() => { this.refresh(); }, 30000);
	}
